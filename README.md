...
1. Add some popups when adding to cart, removing from cart, etc.
2. Create checkout design and render the form and informations depending of items in the cart.
3. Add proper errors to inputs when datas are invalid.
4. After compliting form properly show the order success message.
5. Fix some design and responsiveness issues, add something that will take you to the top of the page when changing site.
6. (Optional) Make some animations, especially for showing menu, cart or order success message.
7. Prepare documentation, take screenshots, write down the process, etc.
8. Submit solution and add to CV.
